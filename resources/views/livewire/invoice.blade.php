    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-orange-100/40 p-8 rounded-3xl">
            <header class="flex justify-between items-center mb-8">
                ...
                <div>
                    <p class="text-orange-600 font-semibold">KANTIN</p>
                    <p>DKI Jakarta</p>
                    <p>Jakarta Pusat</p>
                    <p>daffa@gmail.com</p>
                </div>
            ...
            <div class="mb-8 text-lg">
                <p class="text-orange-600 font-semibold mb-2 text-xl">Tagih Ke:</p>
                <p><strong>Nama</strong> : {{ ucfirst($order->user->name) }}</p>
                <p><strong>Nomor Telepon</strong> : {{ ucfirst($order->user->billingDetails->phone) }}</p>
                <p><strong>Alamat</strong> : {{ ucfirst($order->user->billingDetails->billing_address) }}</p>
                <p><strong>Kota</strong> : {{ ucfirst($order->user->billingDetails->city) }}, <strong>Negara</strong> :
                ...
                <tbody>
                    @foreach ($order->orderItems as $item)
                        <tr class="text-lg">
                            ...
                            <td class="px-4 py-2">Rp{{ $item->product->price }}</td>
                            <td class="px-4 py-2">Rp{{ $item->product->price * $item->quantity }}</td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot class="text-lg">
                    <tr class="font-semibold">
                        ...
                        <td class="px-4 py-2">Rp{{ $order->total }}</td>
                    </tr>
