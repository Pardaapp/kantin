                        ...
                        <div class="sort-by-product-area">
                            <div class="sort-by-cover">
                                <div class="sort-by-product-wrap">
                                    <div class="sort-by">
                                        <span><i class="fi-rs-apps-sort"></i>berdasarkan:</span>
                                    </div>
                                    <div class="sort-by-dropdown-wrap">
                                        <span>
                                            @if ($sort === 'latest')
                                            Terbaru: Baru Dirilis
                                ...
                                <div class="sort-by-dropdown">
                                    <ul>
                                        <li><a class="{{ $sort === 'latest' ? 'active' : '' }}"
                                                href="{{ url()->current() }}?{{ http_build_query(array_merge(request()->query(), ['sort' => 'latest'])) }}">Terbaru: Baru Dirilis</a></li>
                                        <li><a class="{{ $sort === 'low-to-high' ? 'active' : '' }}"
                                                href="{{ url()->current() }}?{{ http_build_query(array_merge(request()->query(), ['sort' => 'low-to-high'])) }}">Harga: Rendah ke Tinggi</a></li>
                                        <li><a class="{{ $sort === 'high-to-low' ? 'active' : '' }}"
                                                href="{{ url()->current() }}?{{ http_build_query(array_merge(request()->query(), ['sort' => 'high-to-low'])) }}">Harga: Tinggi ke Rendah</a></li>
                                        <li><a href="{{ route('home') }}">Penyortiran Bawaan</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="product-cart-wrap mb-30 border-slate-200 shadow-md">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="">
                                                <p class="text-xl font-bold text-orange-500">Rp{{ $p->price }}</p>
                                                <p class="text-md line-through opacity-50">Rp{{ $p->old_price }}</p>
                                            </div>
