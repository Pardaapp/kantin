    ...
    <section class="mt-50 mb-50">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-25">
                        <h4 class="font-semibold text-lg text-gray-600">Detail Pembayaran</h4>
                    </div>
                    <form method="post" action="{{route('checkout.order')}}" id="checkoutForm">
                        @csrf
                        <div class="mb-4">
                            <x-input-label for="country" :value="__('Provinsi *')" />
                        ...
                        <div class="mb-4">
                            <x-input-label for="state" :value="__('Kabupaten / Kota *')" />
                        ...
                        <div class="form-group mb-30">
                            <x-input-label for="order_notes" :value="__('Catatan Tambahan')" />
                ...
                <div class="col-md-6">
                    <div class="order_review border-0">
                        ...
                        <div class="table-responsive order_table text-center">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Pengiriman</th>
                                        <td colspan="2"><em>Bebas biaya kirim</em></td>
                                    </tr>
                                    <tr>
                                        <th>Total</th>
                        ...
                        <button type="submit" class="btn btn-block mt-30" onclick="document.getElementById('checkoutForm').submit();">Lakukan Pemesanan</button>
                    </div>
                </div>
            </div>
        </div>
