                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <ins><span class="text-brand">Rp{{ $product->price }}</span></ins>
                                            <ins><span
                                                    class="old-price font-md ml-15">Rp{{ $product->old_price }}</span></ins>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product_sort_info font-xs mb-30">
                                        <ul>
                                            <li><i class="fi-rs-credit-card mr-5"></i> Pembayaran Tunai tersedia</li>
                                        </ul>
                                    </div>
